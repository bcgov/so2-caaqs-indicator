...
measure sulphur dioxide and other air pollutants. This iteration of the indicator reports on the concentration of sulphur dioxide from two time periods, `r year_range_previous` and `r year_range`.  The data is reported in three-year and annual averages to the [Canadian Ambient Air Quality Standards](https://www.ccme.ca/en/air-quality-report#slide-7)
established by the [Canadian Council of Ministers of the Environment](http://www.ccme.ca).
...
-   **2021-2023: sulphur dioxide levels met the Canadian Ambient Air
...
-   **In both periods, sulphur dioxide levels met the annual Canadian Ambient
    Air Quality Standard in `r as.character(english(summary_prev$az_achieved[summary_prev$metric=="so2_1yr"]))` of B.C.'s seven air zones, and met the 1-hour Standard in `r as.character(english(summary_prev$az_achieved[summary_prev$metric=="so2_3yr"]))` air zones.** The Coastal, Central Interior, Georgia Strait, Northeast, and Lower Fraser Valley air zones met both the annual and 1-hour standards. The Southern Interior exceeded the 1-hour standard. 
...
-   Air quality monitoring stations with at least two years of valid data from `r year_range` and `r year_range_previous`
