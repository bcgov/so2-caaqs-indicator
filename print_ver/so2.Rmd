---
title: "Status of Sulphur Dioxide in B.C. (2020-2022)"
output:
...
-   **Sulphur dioxide levels met both of the Canadian Ambient
    Air Quality Standards in five of B.C.'s seven air zones.** The Coastal, Central Interior, Georgia Strait, Northeast, and Lower Fraser Valley air zones met both the annual and 1-hour standards. The Southern Interior exceeded the 1-hour standard. 
...
*Suggested Citation*:  
Environmental Reporting BC. `r format(Sys.Date(), "%Y")`. Status of Suphur Dioxide in B.C. (`r year_range`). State of Environment Reporting, Ministry of Environment and Climate Change Strategy, British Columbia, Canada.
