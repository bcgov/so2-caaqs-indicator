...
output:
  envreportutils.internal::print_ver: default
...
Published and Available On-Line at Environmental Reporting BC (August 2022):
<http://www.env.gov.bc.ca/soe/indicators/air/so2.html>

Email correspondence to: envreportbc@gov.bc.ca

*Suggested Citation*:  
Environmental Reporting BC. 2022. Status of Suphur Dioxide in B.C. (`r year_range`). State of Environment Reporting, Ministry of Environment and Climate Change Strategy, British Columbia, Canada.
