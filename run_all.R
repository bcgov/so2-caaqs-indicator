...
outfile <- paste0("envreportbc_so2_", mon_year, ".pdf")

rmarkdown::render("print_ver/so2.Rmd", output_file = outfile)
...
air_viz_path <- file.path(air_indicators_path, "so2_viz/")
...
over_copy("out/so2_caaqs_mgmt_map.svg", 
          file.path(air_indicators_path, "images/"))

over_copy("out/so2_caaqs_mgmt_chart.svg", 
          file.path(air_indicators_path, "images/"))
